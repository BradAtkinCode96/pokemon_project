...
2. Construct a team of 6 pokemon, each of which has 4 active moves, out of the ones available. After the team has been chosen, it will be 
3. output into a similarly formatted JSON file, with only the active moves included
